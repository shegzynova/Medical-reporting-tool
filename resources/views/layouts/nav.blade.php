<nav class="bg-white shadow-lg">
            ...
            <div class="flex space-x-7">
                <div>
                    ...
                    <a href="/" class="flex items-center py-4 px-2">
                        ...
                        <span class="font-semibold text-gray-500 text-lg">Patients</span>
                    </a>
                </div>
    ...
    <div class="hidden mobile-menu">
        <ul class="">
            <li class="active"><a href="{{ route('homepage') }}"  class="py-4 px-2 {{ (request()->is('/')) ? 'text-green-500 border-b-4 border-green-500' : 'font-semibold hover:text-green-500 transition duration-300' }}  font-semibold ">Home</a></li>
